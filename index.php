...
<!--###############FORM###########-->
				...
				<form class="login100-form validate-form" action="includes/signup.inc.php" method="POST">
					...
					<div class="wrap-input100 validate-input" >
						...
						<input class="input100" type="text" name="cardnumber" placeholder="Enter your card number...">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						...
						<input class="input100" type="password" name="password" value="" placeholder="*************">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Repeat Password is required">
						<span class="label-input100">Repeat Password</span>
						<input class="input100" type="password" name="re_password" placeholder="*************">
						<span class="focus-input100"></span>
					</div>
